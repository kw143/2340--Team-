...
public enum Good {
    ...
    FOOD("Food", TechLevel.AGRIULTURE, TechLevel.PREAGRICULTURE,  TechLevel.AGRIULTURE,
    ...
    GAMES("Games",  TechLevel.RENAISSANCE, TechLevel.AGRIULTURE,  TechLevel.POSTINDUSTRIAL,
            250,-10, 5,   RadicalPriceEvent.BOREDOM, Resource.ARTISTIC,null,160,270),
    FIREARMS("Firearms",  TechLevel.RENAISSANCE, TechLevel.AGRIULTURE,  TechLevel.INDUSTRIAL,
            1250,-75,100,   RadicalPriceEvent.WAR, Resource.WARLIKE,null,600,1100),
    MEDICINE("Medicine",  TechLevel.EARLYINDUSTRIAL,
            TechLevel.AGRIULTURE,  TechLevel.POSTINDUSTRIAL,
