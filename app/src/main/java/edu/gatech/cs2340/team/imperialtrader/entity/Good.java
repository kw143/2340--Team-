...
public enum Good {
    ...
    FOOD("Food", TechLevel.AGRIULTURE, TechLevel.PREAGRICULTURE,  1, 100,  5, 5,   RadicalPriceEvent.CROPFAIL, Resource.RICHSOIL,Resource.POORSOIL, 90,160),
    ...
    GAMES("Games",  TechLevel.RENAISSANCE, TechLevel.AGRIULTURE,  TechLevel.POSTINDUSTRIAL, 250,-10, TechLevel.INDUSTRIAL,   RadicalPriceEvent.BOREDOM, Resource.ARTISTIC,null,160,270),
